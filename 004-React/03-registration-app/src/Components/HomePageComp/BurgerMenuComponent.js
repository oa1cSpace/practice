...
class BurgerMenuComponent extends React.Component {
    ...
    render() {
        ...
        return (
          ...
          home</span> Главная</a>
                    <a id="about" className="menu-item mb-2" href="/home"> <span
                        className="material-icons icon-bar md-18">face</span> Пользователи</a>
                    <a id="contact" className="menu-item mb-2" href="/home"> <span
                        className="material-icons icon-bar md-18">store</span> Товары</a>
                    <a onClick={this.showSettings} className="menu-item" href="/home"><span
                        className="material-icons icon-bar md-18">assignment</span> Заказы</a>
                </Menu>
                <main id="page-wrap">
