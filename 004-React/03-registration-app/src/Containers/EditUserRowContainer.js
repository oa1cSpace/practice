...
import {generateData, editUser} from "../Components/redux/actions/row";
                ...
                <form className="container-sm mt-5 shadow p-3 mb-5 bg-white rounded width_25"
                    ...
                    <div className='d-flex justify-content-between mt-5'>
                        ...
                        <button
                            ...
                            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-arrow-left-short mr-2"
                        ...
                        <button
                            ...
                            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-file-earmark-plus ml-2"
                                 fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path
